...
<nav class="navbar navbar-light bg-light mb-3">
  ...
  <div class="dropdown">
    <button type="button" class="btn bg-primary bg-gradient text-white btn-sm rounded-circle fs-3 dropdown-toggle"
        style="height: 50px; width:50px;" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false"> 
            <small> <?php echo $user ? Util::InitialsName($user['Nombre'], $user['Apellidos']) : ""; ?></small> 
      </button>
  <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
    <li><a class="dropdown-item" href="<?php echo RUTA_URL . "login/SignOff" ?>">Cerrar Sesión</a></li>
